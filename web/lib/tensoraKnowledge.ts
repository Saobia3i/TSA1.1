...
const staticChunks: KnowledgeChunk[] = [
  ...
  // ─── TEAM MEMBERS ─────────────────────────────
  {
    ...
    body: [
      ...
      "",
      "4. Saobia Islam - Lead Software Engineer",
      "   Saobia Islam is the sole architect and developer behind the entire Tensor Security Academy website and web application.",
    ...
    keywords: [
      ...
      "developer", "built", "made", "website", "created", "software", "chatbot", "tensora",
    ],
  },
  ...
  // ─── WEBSITE CREATOR ─────────────────────────────
  {
    ...
    body: [
      "The entire Tensor Security Academy website and web application was designed, developed, and deployed single-handedly by Saobia Islam, TSA's Lead Software Engineer.",
      "",
      "Saobia built every aspect of this production-grade software from the ground up, including:",
      ...
      "- A full-featured admin dashboard for managing users, enrollments, and web application content.",
      "- SEO optimization, performance tuning, and deployment infrastructure.",
      "",
      "This is not a template or a team effort — Saobia Islam is the sole engineer who conceived, architected, and brought this entire software to life.",
      "Email: islamsaobia@gmail.com",
    ].join("\n"),
    keywords: [
      "website", "made", "built", "created", "developed", "developer", "who",
      "saobia", "islam", "engineer", "software", "pwa", "chatbot", "tensora",
      "frontend", "backend", "design", "code", "web", "app", "application",
    ],
  },
