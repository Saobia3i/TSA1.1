...
const staticChunks: KnowledgeChunk[] = [
  ...
  // ─── TEAM MEMBERS ─────────────────────────────
  {
    ...
    body: [
      ...
      "   Saobia Islam Tinni is the sole architect and developer behind the entire Tensor Security Academy website and platform.",
      ...
      "   The TSA platform is a production-grade, AI-integrated web application that showcases her exceptional full-stack engineering capabilities across frontend design, backend systems, AI/ML integration, and DevOps.",
      "   Saobia is deeply passionate about building software that creates real impact. Her dedication to quality and craft is evident in every pixel and every line of code across the TSA platform.",
