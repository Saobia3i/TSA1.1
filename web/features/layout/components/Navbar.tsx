...
const socialLinks = [
  { 
    name: 'LinkedIn', 
    url: 'https://linkedin.com/company/tensor-security', 
    icon: Linkedin,
  },
  { 
    name: 'Instagram', 
    url: 'https://instagram.com/tensorsecurity', 
    icon: Instagram,
  },
  { 
    name: 'Facebook', 
    url: 'https://facebook.com/tensorsecurity', 
    icon: Facebook,
  },
  { 
    name: 'X', 
    url: 'https://x.com/tensorsecurity', 
    icon: Twitter, // X uses Twitter icon
  },
];
                  ...
                  >
                    {socialLinks.map((social) => {
                      ...
                      return (
                        ...
                        >
                          {/* ✅ Lucide icon in white bordered circle */}
                          <div style={{ 
                            width: '32px', 
                            height: '32px', 
                            borderRadius: '50%', 
