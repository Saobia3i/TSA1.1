...
const socialLinks = [
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/tensor_security_academy",
    icon: Instagram,
  },
        ...
        >
          ...
          >
            ...
            <div ref={aboutRef} style={{ position: "relative" }}>
              <div
                className={`nav-link-wrapper ${isAboutActive ? "active" : ""}`}
              >
                <button
            ...
            >
              ...
              <nav aria-label="Mobile navigation">
                ...
                <div style={{ marginTop: "8px" }}>
                  <button
                    onClick={() =>
                      setAboutDropdownOpenMobile(!aboutDropdownOpenMobile)
                    }
                    style={{
                      width: "100%",
                      padding: "14px 18px",
                  ...
                  >
                    ...
                    <ChevronDown
                      style={{
                        width: "20px",
                        height: "20px",
                        transform: aboutDropdownOpenMobile
                          ? "rotate(180deg)"
                          : "rotate(0deg)",
                        transition: "transform 0.3s ease",
                      }}
