...
import { ArrowLeft, MessageSquare, Quote, Sparkles, Mail } from "lucide-react";
...
const teamMembers = [
  ...
  },
  {
    ...
    image: "",
    quote:
      "Real-world cybersecurity isn't learned from books alone. TSA Labs gives students hands-on experience with the actual challenges they'll face in their careers.",
    socials: {
          ...
          <div className={styles.founderRow}>
            ...
            >
              <motion.div
                ...
                style={{
                  background:
                    "radial-gradient(circle, rgba(255, 215, 0, 0.3), transparent 60%)",
                }}
              />

              <div
                className={styles.compactCardBadge}
                style={{
                  background:
              ...
              <p
                className={styles.compactCardRole}
            ...
            {members.map((member, index) => (
              ...
              >
                ...
                <div
                  ...
                  onClick={() =>
                    setExpandedCard(
                      expandedCard === index + 1 ? null : index + 1
                    )
                  }
                  style={{
                    cursor: "pointer",
                    fontSize: "18px",
                    color: expandedCard === index + 1 ? "#00d4ff" : "#ccc",
                  }}
                >
                  <Quote />
                </div>
